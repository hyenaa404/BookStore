 ...
 * @author LENOVO
 */
public class DisplayButtonFilter implements Filter {
    ...
    public DisplayButtonFilter() {
    }

    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("DisplayButtonFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("DisplayButtonFilter:DoAfterProcessing");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("DisplayButtonFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("DisplayButtonFilter()");
        }
        StringBuffer sb = new StringBuffer("DisplayButtonFilter(");
