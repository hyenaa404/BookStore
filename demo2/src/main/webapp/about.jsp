...
<section class="section section-bg" class="call-to-action"
         style="background-image: url(${pageContext.request.contextPath}/assets/images/banner-image-1-1920x500.jpg)">
    <div class="container">
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="cta-content">
                    <br>
                    <br>
                    <h2><em>Đọc thêm về chúng tôi</em></h2>
                    <p>Chúng tôi tự hào là đơn vị dẫn đầu trong phân khúc xe lướt với các thương
        ...
        <div class="row" id="tabs">
            ...
            <div class="col-lg-8">
                <section class='tabs-content'>
                    <article id='tabs-1'>
                        <img src="${pageContext.request.contextPath}/assets/images/about-image-1-940x460.jpg" alt="">
                        <h4>Mục tiêu</h4>
                    ...
                    <article id='tabs-2'>
                        <img src="${pageContext.request.contextPath}/assets/images/about-image-2-940x460.jpg" alt="">
                        <h4>Công việc</h4>
                    ...
                    <article id='tabs-3'>
                        <img src="${pageContext.request.contextPath}/assets/images/about-image-3-940x460.jpg" alt="">
                        <h4>Đam mê</h4>
